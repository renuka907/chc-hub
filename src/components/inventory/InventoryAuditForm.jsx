                        ...
                        <table style={{
                            ...
                            <thead>
                                <tr style={{backgroundColor: '#e5e7eb'}}>
                                    <th style={{border: '1px solid #666', padding: '3px 6px', textAlign: 'left', fontSize: '11px', fontWeight: 'bold'}}>Item</th>
                                    <th style={{border: '1px solid #666', padding: '3px 4px', textAlign: 'center', fontSize: '11px', fontWeight: 'bold', width: '75px'}}>Type</th>
                                    <th style={{border: '1px solid #666', padding: '3px 6px', textAlign: 'center', fontSize: '11px', fontWeight: 'bold', width: '60px'}}>SKU</th>
                                    <th style={{border: '1px solid #666', padding: '3px 6px', textAlign: 'center', fontSize: '11px', fontWeight: 'bold', width: '60px'}}>Exp</th>
                                    <th style={{border: '1px solid #666', padding: '3px 6px', textAlign: 'center', fontSize: '11px', fontWeight: 'bold', width: '60px'}}>Unit</th>
                                    <th style={{border: '1px solid #666', padding: '3px 6px', textAlign: 'center', fontSize: '11px', fontWeight: 'bold', width: '50px'}}>Qty</th>
                                    <th style={{border: '1px solid #666', padding: '3px 6px', textAlign: 'center', fontSize: '11px', fontWeight: 'bold', width: '90px'}}>New</th>
                                </tr>
                            </thead>
                            <tbody>
                                {storageItems.map(item => (
                                    <tr key={item.id}>
                                        <td style={{border: '1px solid #999', padding: '3px 6px', fontSize: '11px'}}>{item.item_name}</td>
                                        <td style={{border: '1px solid #999', padding: '3px 4px', textAlign: 'center', fontSize: '11px'}}>{item.item_type}</td>
                                        <td style={{border: '1px solid #999', padding: '3px 6px', textAlign: 'center', fontSize: '11px'}}>{item.sku || '-'}</td>
                                        <td style={{border: '1px solid #999', padding: '3px 6px', textAlign: 'center', fontSize: '11px'}}>
                                            {item.expiry_date ? new Date(item.expiry_date).toLocaleDateString('en-US', {month: '2-digit', day: '2-digit', year: '2-digit'}) : '-'}
                                        </td>
                                        <td style={{border: '1px solid #999', padding: '3px 6px', textAlign: 'center', fontSize: '11px'}}>{item.unit}</td>
                                        <td style={{border: '1px solid #999', padding: '3px 6px', textAlign: 'center', fontWeight: 'bold', fontSize: '11px'}}>{item.quantity}</td>
