...
const STUDIES = [
  ...
  },
  {
    id: "breast_biopsy",
    category: "Breast Imaging",
    name: "Breast Biopsy (Image-Guided Core Needle)",
    cptHint: "19083 (US-guided), 19081 (stereotactic), 19085 (MRI-guided)",
    icd10Suggestions: [
      { code: "R92.8", desc: "Other abnormal and inconclusive findings on diagnostic imaging of breast (BI-RADS 4/5)" },
      { code: "N63.10", desc: "Unspecified lump in the right breast, unspecified quadrant" },
      { code: "N63.20", desc: "Unspecified lump in the left breast, unspecified quadrant" },
      { code: "D48.61", desc: "Neoplasm of uncertain behavior of right breast" },
      { code: "D48.62", desc: "Neoplasm of uncertain behavior of left breast" },
      { code: "Z85.3", desc: "Personal history of malignant neoplasm of breast" },
      { code: "N64.51", desc: "Induration of breast (palpable thickening)" },
      { code: "N64.52", desc: "Nipple discharge" },
      { code: "Z12.31", desc: "Encounter for screening mammogram — with biopsy follow-up" },
    ],
    prepInstructions: [
      "Do NOT take aspirin, ibuprofen (Advil/Motrin), naproxen (Aleve), or any blood thinners for 5–7 days before the biopsy — check with your provider if you are on prescription blood thinners (warfarin, Eliquis, Xarelto).",
      "Acetaminophen (Tylenol) is safe to take before and after the procedure.",
      "Do NOT apply deodorant, antiperspirant, lotion, or powder to the breast or underarm area on the day of the procedure.",
      "Wear a comfortable, supportive bra on the day of the procedure — it will help hold the ice pack/dressing afterward.",
      "Eat a normal meal before your appointment — fasting is NOT required.",
      "Arrange for someone to drive you home if you receive sedation or feel anxious.",
      "You may return to normal activities the day after. Avoid strenuous exercise for 24–48 hours.",
      "A small bandage and ice pack will be applied after the procedure. Bruising is normal and expected.",
      "A tiny titanium marker clip will be placed at the biopsy site — it is safe for future MRI and helps radiologists locate the area on follow-up imaging.",
      "Results are typically available within 3–5 business days. Your provider will call you with results.",
      "Inform the facility if you are on blood thinners, have a bleeding disorder, breast implants, or are pregnant.",
    ],
    patientNote: "A breast biopsy uses a small needle guided by ultrasound, mammogram (stereotactic), or MRI to remove a tiny tissue sample from the area of concern. Local anesthesia is used — you will feel pressure but not significant pain. Most biopsies take 30–60 minutes and you go home the same day. A small titanium clip will be left at the site for future reference.",
  },
  {
    id: "scrotal_us",
    category: "Abdominal / Urologic",
    name: "Scrotal Ultrasound",
    cptHint: "76870 (scrotum and contents)",
    icd10Suggestions: [
      { code: "N50.89", desc: "Other specified disorders of male genital organs (scrotal mass/lump)" },
      { code: "N45.1", desc: "Epididymo-orchitis" },
      { code: "N45.3", desc: "Orchitis" },
      { code: "N45.2", desc: "Epididymitis" },
      { code: "N43.3", desc: "Hydrocele, unspecified" },
      { code: "N43.40", desc: "Spermatocele of epididymis, unspecified" },
      { code: "N44.00", desc: "Testicular torsion, unspecified" },
      { code: "C62.91", desc: "Malignant neoplasm of unspecified testis, undescended (testicular cancer workup)" },
      { code: "R10.2", desc: "Pelvic and perineal pain (scrotal/groin pain)" },
      { code: "I86.1", desc: "Scrotal varices (varicocele)" },
      { code: "N50.1", desc: "Vascular disorders of male genital organs" },
    ],
    prepInstructions: [
      "No fasting or special preparation is required.",
      "Wear loose, comfortable clothing that allows easy access to the scrotal area.",
      "You will be asked to lie flat on your back on the exam table.",
      "A towel or sheet will be draped across the thighs for support and privacy.",
      "Warm gel will be applied and the technologist will gently move the ultrasound probe over the scrotum.",
      "Inform the technologist of your specific symptoms — pain, swelling, lump, or injury — and how long they have been present.",
      "If evaluating for torsion: this is a TIME-SENSITIVE exam — notify the facility and the on-call provider immediately.",
      "The exam takes approximately 15–20 minutes.",
      "Color Doppler will be used to assess blood flow to each testicle.",
    ],
    patientNote: "A scrotal ultrasound uses sound waves (no radiation) to evaluate the testicles and surrounding structures. It checks for lumps, cysts, infections, fluid collections, or blood flow problems. The exam is painless and performed with respect for your privacy.",
  },
  {
    id: "groin_us",
    category: "Abdominal / Urologic",
    name: "Groin / Inguinal Ultrasound",
    cptHint: "76882 (limited joint/soft tissue), 76881 (complete), 93971 (if vascular/venous)",
    icd10Suggestions: [
      { code: "K40.90", desc: "Unilateral inguinal hernia, without obstruction or gangrene, not recurrent" },
      { code: "K40.20", desc: "Bilateral inguinal hernia, without obstruction or gangrene, not recurrent" },
      { code: "R22.31", desc: "Localized swelling, mass and lump, right upper limb / groin" },
      { code: "R22.32", desc: "Localized swelling, mass and lump, left groin" },
      { code: "L04.1", desc: "Acute lymphadenitis of trunk (inguinal lymph node swelling)" },
      { code: "R59.0", desc: "Localized enlarged lymph nodes (inguinal)" },
      { code: "I82.401", desc: "Acute DVT, lower extremity — femoral vein evaluation" },
      { code: "I83.90", desc: "Varicose veins of unspecified lower extremity (groin varicosities)" },
      { code: "M79.3", desc: "Panniculitis (soft tissue mass, groin)" },
      { code: "N50.89", desc: "Other specified disorders of male genital organs (scrotal/groin mass)" },
    ],
    prepInstructions: [
      "No fasting or special preparation is required.",
      "Wear loose, comfortable clothing that allows easy access to the groin and hip area.",
      "You will lie flat on the exam table.",
      "Gel will be applied to the groin area and the technologist will use a small wand to image the soft tissues and vessels.",
      "Inform the technologist of your specific concern — hernia, lump, lymph node, or vascular — so the correct protocol is used.",
      "If evaluating for hernia: you may be asked to stand or perform a Valsalva (bear down/cough) during the exam.",
      "If evaluating for vascular concern: femoral and saphenous vein compression will be included.",
      "The exam takes approximately 15–30 minutes.",
      "Do NOT apply creams or lotions to the groin area before the exam.",
    ],
    patientNote: "This ultrasound evaluates the groin area for hernias, enlarged lymph nodes, cysts, or vascular concerns. It uses sound waves and is completely painless. Please let the technologist know the specific reason for your exam.",
  },
  {
    id: "dvt_us",
    category: "Vascular",
    name: "Lower Extremity Venous Duplex Ultrasound (DVT Rule-Out)",
    cptHint: "93971 (unilateral), 93970 (bilateral)",
    icd10Suggestions: [
      { code: "I82.401", desc: "Acute DVT of unspecified deep veins of right lower extremity" },
      { code: "I82.402", desc: "Acute DVT of unspecified deep veins of left lower extremity" },
      { code: "I82.409", desc: "Acute DVT of unspecified deep veins of unspecified lower extremity" },
      { code: "R22.41", desc: "Localized swelling, mass and lump, right lower limb" },
      { code: "R22.42", desc: "Localized swelling, mass and lump, left lower limb" },
      { code: "R60.0", desc: "Localized edema (unilateral leg swelling)" },
      { code: "M79.671", desc: "Pain in right foot/leg" },
      { code: "M79.672", desc: "Pain in left foot/leg" },
      { code: "Z79.01", desc: "Long-term use of anticoagulants (monitoring)" },
      { code: "Z96.641", desc: "Presence of right artificial hip joint (post-op DVT risk)" },
      { code: "Z87.39", desc: "Personal history of DVT/PE" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Wear loose, comfortable clothing that allows easy access to both legs.",
      "You will lie on an exam table with your leg slightly bent and rotated outward.",
      "Gel will be applied to your leg and the technologist will press a small wand along the veins from groin to ankle.",
      "The technologist will gently compress the vein with the probe — this is normal and helps detect clots.",
      "The exam is generally painless. If your leg is very swollen or tender, inform the technologist.",
      "The exam takes approximately 30–45 minutes per leg.",
      "Do NOT massage or rub the affected leg before or after the exam.",
      "If a clot is found, the radiologist may call your provider directly — do not leave without speaking to staff.",
    ],
    patientNote: "This ultrasound uses sound waves (no radiation) to check the veins in your leg for a blood clot (DVT). The technologist will press the probe along your leg to check blood flow. If you have significant pain or swelling, please tell the staff immediately.",
  },
  {
    id: "carotid_us",
    category: "Vascular",
  ...
  // ───────────────────────────── X-RAYS ────────────────────────────
  {
    ...
    cptHint: "71046 (2 views), 71045 (1 view)",
    icd10Suggestions: [
      { code: "R05.9", desc: "Cough, unspecified" },
      { code: "R06.09", desc: "Dyspnea, other (shortness of breath)" },
      ...
      { code: "Z87.891", desc: "Personal history of nicotine dependence (lung screening)" },
      { code: "I50.9", desc: "Heart failure, unspecified" },
      { code: "R04.2", desc: "Hemoptysis (coughing up blood)" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Remove all clothing from the waist up and change into a gown.",
      "Remove all jewelry, necklaces, and bras with underwire.",
      "Inform the technologist if you are pregnant or may be pregnant.",
      "You will be asked to take a deep breath and hold it briefly during the image.",
      "The exam takes less than 5 minutes.",
    ],
    patientNote: "A chest X-ray uses a small amount of radiation to create images of your lungs, heart, and chest wall. It is quick and painless.",
  },
  {
    id: "xray_lumbar",
    category: "X-Ray",
    name: "X-Ray — Lumbar Spine",
    cptHint: "72100 (2 views), 72110 (4+ views)",
    icd10Suggestions: [
      ...
      { code: "S39.012A", desc: "Strain of muscle of lower back, initial encounter" },
      { code: "M81.0", desc: "Age-related osteoporosis (compression fracture evaluation)" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "You will need to change into a gown.",
      "Remove all belts, jewelry, and metal objects from the waist area.",
      "Inform the technologist if you are pregnant or may be pregnant.",
      "You will be positioned lying flat and may be asked to hold still briefly.",
      "The exam takes approximately 5–10 minutes.",
    ],
    patientNote: "A lumbar spine X-ray provides images of the bones in your lower back. It can identify arthritis, disc problems, fractures, or alignment issues.",
  },
  {
    id: "xray_cervical",
    category: "X-Ray",
    name: "X-Ray — Cervical Spine (Neck)",
    cptHint: "72040 (2-3 views), 72050 (4+ views)",
    icd10Suggestions: [
      { code: "M54.2", desc: "Cervicalgia (neck pain)" },
      { code: "M50.30", desc: "Other cervical disc degeneration, unspecified level" },
      { code: "M47.812", desc: "Spondylosis, cervical region" },
      { code: "S19.9XXA", desc: "Unspecified injury of neck, initial encounter (whiplash)" },
      { code: "M54.12", desc: "Radiculopathy, cervical region (arm pain/numbness)" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Remove all necklaces, earrings, and hair clips.",
      "You may be asked to sit upright or lie down depending on the views ordered.",
      "Inform the technologist if you are pregnant or may be pregnant.",
      "The exam takes approximately 5 minutes.",
    ],
    patientNote: "A cervical spine X-ray takes images of the bones in your neck. It helps identify arthritis, disc wear, or injury-related changes.",
  },
  {
    id: "xray_knee",
    category: "X-Ray",
    name: "X-Ray — Knee",
    cptHint: "73560 (2 views), 73562 (3 views), 73564 (4+ views)",
    icd10Suggestions: [
      { code: "M17.11", desc: "Primary osteoarthritis, right knee" },
      { code: "M17.12", desc: "Primary osteoarthritis, left knee" },
      { code: "M25.361", desc: "Stiffness of right knee" },
      { code: "M79.36", desc: "Pain in knee" },
      { code: "S80.911A", desc: "Unspecified superficial injury of right knee, initial encounter" },
      { code: "M23.200", desc: "Derangement of unspecified meniscus" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Wear or bring shorts if possible — you may need to roll up your pants.",
      "Remove any knee braces or supports before the exam.",
      "Weight-bearing (standing) views may be requested — notify if you cannot stand.",
      "The exam takes approximately 5–10 minutes.",
    ],
    patientNote: "A knee X-ray shows the bones of your knee joint and helps identify arthritis, fractures, or alignment issues. It is quick and painless.",
  },
  {
    id: "xray_hip",
    category: "X-Ray",
    name: "X-Ray — Hip (Pelvis + Hip)",
    cptHint: "73500 (hip 2 views), 72170 (pelvis AP)",
    icd10Suggestions: [
      { code: "M16.11", desc: "Primary osteoarthritis, right hip" },
      { code: "M16.12", desc: "Primary osteoarthritis, left hip" },
      { code: "M79.35", desc: "Pain in hip" },
      { code: "S72.001A", desc: "Fracture of unspecified part of neck of right femur, initial encounter" },
      { code: "M81.0", desc: "Age-related osteoporosis (fall/fracture risk)" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "You will need to change into a gown.",
      "Remove all metal objects, belts, and jewelry from the hip/pelvic area.",
      "Inform the technologist if you are pregnant or may be pregnant.",
      "You will lie flat on a table for the exam.",
      "The exam takes approximately 5–10 minutes.",
    ],
    patientNote: "A hip X-ray provides images of the hip joint and surrounding bones to evaluate arthritis, fractures, or alignment.",
  },
  {
    id: "xray_shoulder",
    category: "X-Ray",
    name: "X-Ray — Shoulder",
    cptHint: "73030 (complete, minimum 2 views)",
    icd10Suggestions: [
      { code: "M75.10", desc: "Rotator cuff syndrome, unspecified shoulder" },
      { code: "M19.011", desc: "Primary osteoarthritis, right shoulder" },
      { code: "M79.621", desc: "Pain in right upper arm/shoulder" },
      { code: "S40.011A", desc: "Contusion of right shoulder, initial encounter" },
      { code: "M75.50", desc: "Bursitis of unspecified shoulder" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Wear or bring a loose top or tank top — you may need to remove your shirt.",
      "Remove all shoulder and neck jewelry.",
      "The exam takes approximately 5 minutes.",
    ],
    patientNote: "A shoulder X-ray shows the bones of the shoulder joint and helps evaluate pain, injury, or arthritis.",
  },
  {
    id: "xray_hand_wrist",
    category: "X-Ray",
    name: "X-Ray — Hand / Wrist",
    cptHint: "73130 (hand 3 views), 73100 (wrist 2 views)",
    icd10Suggestions: [
      { code: "M19.041", desc: "Primary osteoarthritis, right hand" },
      { code: "M79.641", desc: "Pain in right hand" },
      { code: "S62.001A", desc: "Fracture of unspecified carpal bone, initial encounter" },
      { code: "M65.311", desc: "Trigger finger, right index finger" },
      { code: "M05.741", desc: "Rheumatoid arthritis, right hand" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Remove all rings, bracelets, and wrist accessories.",
      "The exam takes approximately 5 minutes.",
    ],
    patientNote: "A hand or wrist X-ray images the bones in your hand or wrist to check for fractures, arthritis, or other bone abnormalities.",
  },
  ...
  // ───────────────────────────── CT SCANS ────────────────────────────
  {
    ...
    cptHint: "70450 (without contrast), 70460 (with contrast), 70470 (with & without)",
    icd10Suggestions: [
      { code: "R51.9", desc: "Headache, unspecified" },
      { code: "G43.909", desc: "Migraine, unspecified, not intractable" },
      { code: "R55", desc: "Syncope and collapse (fainting)" },
      { code: "G45.9", desc: "Transient ischemic attack (TIA), unspecified" },
      { code: "R41.3", desc: "Other amnesia / cognitive changes" },
      { code: "S09.90XA", desc: "Unspecified injury of head, initial encounter (trauma/fall)" },
      { code: "R42", desc: "Dizziness and giddiness" },
    ],
    prepInstructions: [
      "No fasting is required for a CT head without contrast.",
      "Remove all hair clips, earrings, glasses, and hearing aids.",
      "Inform the technologist if you have a pacemaker, cochlear implant, or metal in your head/neck.",
      "If contrast is ordered: inform facility of kidney disease, diabetes, prior contrast reactions, or metformin use.",
      "You will lie flat and the scanner will move around your head — you will not go fully inside a tube.",
      "The exam takes approximately 10–15 minutes.",
      "Do not move your head during the scan.",
    ],
    patientNote: "A CT scan of the head uses X-rays to create detailed cross-sectional images of the brain. It is used to check for stroke, bleeding, tumors, or other abnormalities. It is painless and quick.",
  },
  {
    id: "ct_abdomen_pelvis",
    category: "CT Scan",
    name: "CT — Abdomen & Pelvis (with contrast)",
    cptHint: "74177 (with contrast), 74178 (with & without), 74176 (without contrast)",
    icd10Suggestions: [
      { code: "R10.9", desc: "Unspecified abdominal pain" },
      ...
      { code: "N20.0", desc: "Calculus of kidney (kidney stone)" },
      { code: "K35.80", desc: "Appendicitis without abscess" },
      { code: "R19.09", desc: "Intra-abdominal and pelvic swelling, mass and lump" },
      { code: "N83.20", desc: "Unspecified ovarian cysts" },
    ],
    prepInstructions: [
      "Do NOT eat or drink (except water) for 4 hours before the exam.",
      "You may be given oral contrast (a liquid to drink) upon arrival — arrive 1 hour early if instructed.",
      "Inform the facility if you have kidney disease, diabetes (metformin), prior contrast reactions, or shellfish allergy.",
      "IV contrast (dye) will be injected through an IV in your arm — you may feel a brief warm sensation.",
      "Remove all jewelry, belts, and metal objects from the abdomen.",
      "If you take metformin, you may need to hold it 48 hours after the scan.",
      "The exam takes approximately 15–20 minutes.",
    ],
    patientNote: "A CT of the abdomen and pelvis creates detailed images of your organs including the liver, kidneys, bowel, and pelvis using X-rays and IV contrast dye. It is used to evaluate pain, masses, or other abdominal concerns.",
  },
  {
    id: "ct_lumbar",
    category: "CT Scan",
    name: "CT — Lumbar Spine",
    cptHint: "72131 (without contrast), 72132 (with contrast)",
    icd10Suggestions: [
      { code: "M54.5", desc: "Low back pain" },
      { code: "M51.16", desc: "Intervertebral disc degeneration, lumbar region" },
      { code: "M48.06", desc: "Spinal stenosis, lumbar region" },
      { code: "M54.4", desc: "Lumbago with sciatica" },
      { code: "M43.16", desc: "Spondylolisthesis, lumbar region" },
    ],
    prepInstructions: [
      "No fasting required for CT spine without contrast.",
      "Remove all metal objects, jewelry, and belts.",
      "You will lie flat on a table that slides through the scanner.",
      "The exam takes approximately 10–15 minutes.",
      "If contrast is ordered: inform facility of kidney disease, prior contrast reactions, or metformin use.",
    ],
    patientNote: "A CT of the lumbar spine provides detailed cross-sectional images of the bones and discs in your lower back. It is more detailed than an X-ray for evaluating disc herniation, stenosis, or fractures.",
  },
  {
    id: "ct_sinuses",
    category: "CT Scan",
    name: "CT — Sinuses",
    cptHint: "70486 (without contrast), 70487 (with contrast)",
    icd10Suggestions: [
      { code: "J32.9", desc: "Chronic sinusitis, unspecified" },
      { code: "J01.90", desc: "Acute sinusitis, unspecified" },
      { code: "J34.3", desc: "Hypertrophy of nasal turbinates" },
      { code: "J33.9", desc: "Nasal polyp, unspecified" },
      { code: "R09.81", desc: "Nasal congestion" },
    ],
    prepInstructions: [
      "No special preparation is required.",
      "Blow your nose before the exam if congested.",
      "Remove all glasses, earrings, and facial piercings.",
      "You will lie flat and the scanner will image your face and sinuses.",
      "The exam takes approximately 5–10 minutes.",
    ],
    patientNote: "A CT of the sinuses creates detailed images of your sinus cavities to evaluate chronic or recurrent sinus infections, polyps, or structural issues.",
  },
  {
    id: "ct_chest_lung",
    category: "CT Scan",
    name: "CT — Chest / Lung Screening (Low-Dose)",
    cptHint: "71271 (low-dose lung cancer screening), 71250 (without contrast)",
    icd10Suggestions: [
      { code: "Z87.891", desc: "Personal history of nicotine dependence (LDCT eligibility)" },
      { code: "F17.210", desc: "Nicotine dependence, cigarettes (current smoker)" },
      { code: "R91.8", desc: "Other nonspecific abnormal finding of lung field (nodule follow-up)" },
      { code: "Z12.11", desc: "Encounter for screening for malignant neoplasm of colon (lung analog)" },
      { code: "J44.9", desc: "COPD, unspecified" },
    ],
    prepInstructions: [
      "No special preparation is required for low-dose CT (no IV contrast).",
      "Do NOT smoke on the day of the exam if possible.",
      "Wear comfortable, loose-fitting clothing without metal.",
      "Remove all necklaces and chest jewelry.",
      "You will be asked to hold your breath briefly during the scan.",
      "The exam takes approximately 10 minutes.",
      "Note: Annual low-dose CT lung screening is covered by insurance for adults 50–80 years old with a 20+ pack-year smoking history who currently smoke or quit within the past 15 years.",
    ],
    patientNote: "A low-dose CT lung screening is a quick, painless scan that can detect early lung cancer in people who have a significant smoking history. No IV dye is needed for the screening version.",
  },
  ...
  // ───────────────────────────── MRI ────────────────────────────
  {
    id: "mri_brain",
    category: "MRI",
    name: "MRI — Brain (without & with contrast)",
    cptHint: "70553 (with & without contrast), 70551 (without contrast)",
    icd10Suggestions: [
      { code: "G35", desc: "Multiple sclerosis" },
      { code: "R51.9", desc: "Headache, unspecified" },
      { code: "G43.909", desc: "Migraine, unspecified, not intractable" },
      { code: "G45.9", desc: "Transient ischemic attack, unspecified" },
      { code: "R41.3", desc: "Other amnesia / cognitive decline" },
      { code: "G40.909", desc: "Epilepsy, unspecified, not intractable" },
      { code: "D35.2", desc: "Benign neoplasm of pituitary gland" },
      { code: "R42", desc: "Dizziness / vertigo" },
    ],
    prepInstructions: [
      "Inform the facility of ALL metal in or on your body: pacemakers, defibrillators, cochlear implants, aneurysm clips, metal fragments, joint replacements, or surgical hardware.",
      "MRI uses strong magnets — metal implants may be a contraindication.",
      "Remove all jewelry, piercings, hairpins, hearing aids, glasses, and removable dental work before the scan.",
      "No fasting required unless contrast is being used (then avoid heavy meals).",
      "If you are claustrophobic, notify your provider in advance — sedation may be available.",
      "Wear comfortable, metal-free clothing or change into a gown.",
      "The exam takes approximately 30–60 minutes. You must lie very still inside the scanner.",
      "The machine makes loud knocking sounds — earplugs or headphones will be provided.",
      "IV contrast (gadolinium) may be used — inform facility of kidney disease.",
    ],
    patientNote: "An MRI of the brain creates very detailed images using magnetic fields (no radiation). It is used to evaluate headaches, neurological symptoms, or suspected brain conditions. The scanner is a large tube and can feel enclosed — let us know if you have anxiety in small spaces.",
  },
  {
    id: "mri_lumbar",
    category: "MRI",
    name: "MRI — Lumbar Spine (without contrast)",
    cptHint: "72148 (without contrast), 72149 (with contrast), 72158 (with & without)",
    icd10Suggestions: [
      { code: "M54.5", desc: "Low back pain" },
      { code: "M51.16", desc: "Intervertebral disc degeneration, lumbar region" },
      { code: "M54.4", desc: "Lumbago with sciatica" },
    ...
    prepInstructions: [
      "Inform the facility of all metal implants, surgical hardware, or devices (pacemaker, spinal stimulator, etc.).",
      "Remove all jewelry, belt buckles, and metal objects.",
      "No fasting required.",
      "Wear comfortable, metal-free clothing or change into a gown.",
      "If claustrophobic, notify your provider — open MRI or sedation may be available.",
      "The exam takes approximately 30–45 minutes.",
      "You must lie very still — movement blurs the images.",
    ],
    patientNote: "An MRI of the lumbar spine provides the most detailed images of the discs, nerves, and spinal cord in your lower back. No radiation is used. This is the preferred study for evaluating sciatica, herniated discs, or nerve compression.",
  },
  {
    id: "mri_cervical",
    category: "MRI",
    name: "MRI — Cervical Spine (Neck)",
    cptHint: "72141 (without contrast), 72142 (with contrast)",
    icd10Suggestions: [
      { code: "M54.2", desc: "Cervicalgia (neck pain)" },
      { code: "M54.12", desc: "Radiculopathy, cervical region (arm numbness/pain)" },
      { code: "M50.20", desc: "Cervical disc displacement, unspecified level" },
      { code: "M47.812", desc: "Spondylosis, cervical region" },
      { code: "G54.2", desc: "Cervical root disorders" },
    ],
    prepInstructions: [
      "Inform the facility of all metal implants, surgical hardware, or devices.",
      "Remove all necklaces, earrings, and hair clips.",
      "No fasting required.",
      "If claustrophobic, notify your provider in advance.",
      "The exam takes approximately 30–45 minutes.",
    ],
    patientNote: "An MRI of the cervical spine provides detailed images of the bones, discs, and nerves in your neck. It is the best study for evaluating neck pain with arm symptoms or suspected nerve compression.",
  },
  {
    id: "mri_knee",
    category: "MRI",
    name: "MRI — Knee",
    cptHint: "73721 (without contrast), 73723 (with & without)",
    icd10Suggestions: [
      { code: "M23.200", desc: "Derangement of unspecified meniscus" },
      { code: "M23.61", desc: "Other spontaneous disruption of anterior cruciate ligament of right knee" },
      { code: "M79.36", desc: "Pain in knee" },
      { code: "M17.11", desc: "Primary osteoarthritis, right knee" },
      { code: "S83.006A", desc: "Unspecified tear of medial meniscus, current injury, right knee" },
    ],
    prepInstructions: [
      "No fasting required.",
      "Inform the facility of any metal implants or prior knee surgeries with hardware.",
      "Remove all jewelry and metal objects.",
      "Wear comfortable shorts or loose pants (you may need to change).",
      "You will lie with your knee inside the scanner — it is less enclosed than a brain MRI.",
      "The exam takes approximately 30–45 minutes.",
    ],
    patientNote: "An MRI of the knee creates detailed images of the cartilage, ligaments, and soft tissue around the knee joint. It is used to evaluate injuries, meniscus tears, or ligament damage. No radiation is used.",
  },
  {
    id: "mri_shoulder",
    category: "MRI",
    name: "MRI — Shoulder",
    cptHint: "73221 (without contrast), 73223 (with & without)",
    icd10Suggestions: [
      { code: "M75.10", desc: "Rotator cuff syndrome, unspecified shoulder" },
      { code: "M75.100", desc: "Unspecified rotator cuff tear or rupture, not specified as traumatic" },
      { code: "M75.50", desc: "Bursitis of shoulder" },
      { code: "M79.621", desc: "Pain in right upper arm/shoulder" },
      { code: "S46.011A", desc: "Strain of rotator cuff, initial encounter" },
    ],
    prepInstructions: [
      "No fasting required.",
      "Inform the facility of any metal implants or prior shoulder surgeries.",
      "Remove all jewelry and metal objects from the shoulder and neck area.",
      "You will lie flat with your arm at your side or positioned as directed.",
      "The exam takes approximately 30–45 minutes.",
    ],
    patientNote: "An MRI of the shoulder provides detailed images of the rotator cuff, tendons, and soft tissue. It is the best way to evaluate rotator cuff tears, bursitis, or labral injuries without radiation.",
  },
  {
    id: "mri_breast",
    category: "MRI",
    name: "MRI — Breast (with contrast)",
    cptHint: "77049 (bilateral, with & without contrast)",
    icd10Suggestions: [
      { code: "Z85.3", desc: "Personal history of malignant neoplasm of breast" },
      { code: "Z80.3", desc: "Family history of malignant neoplasm of breast" },
      { code: "Z15.01", desc: "Genetic susceptibility to malignant neoplasm of breast (BRCA+)" },
      { code: "R92.8", desc: "Other abnormal and inconclusive findings on diagnostic imaging of breast" },
      { code: "N63.10", desc: "Unspecified lump in the right breast" },
    ],
    prepInstructions: [
      "Schedule the exam on days 7–14 of your menstrual cycle (if premenopausal) for best image quality.",
      "Inform the facility of all metal implants (note: breast implants are generally safe for MRI).",
      "IV contrast (gadolinium) is required — inform facility of kidney disease.",
      "Do NOT apply lotions, deodorant, or powders to the chest/underarm area on the day of the exam.",
      "Remove all jewelry and metal objects.",
      "You will lie face-down with your breasts positioned in a special coil — this may feel unusual but is not painful.",
      "The exam takes approximately 45–60 minutes.",
      "If claustrophobic, notify your provider in advance.",
    ],
    patientNote: "A breast MRI uses magnetic fields (no radiation) with IV contrast to provide highly detailed images of breast tissue. It is used for high-risk screening, staging known breast cancer, or evaluating findings seen on other imaging.",
  },
  {
    id: "mri_pelvis",
    category: "MRI",
    name: "MRI — Pelvis (Female)",
    cptHint: "72195 (without contrast), 72197 (with & without contrast)",
    icd10Suggestions: [
      { code: "D25.9", desc: "Leiomyoma of uterus, unspecified (fibroids)" },
      { code: "N80.9", desc: "Endometriosis, unspecified" },
      { code: "N83.20", desc: "Unspecified ovarian cysts" },
    ...
    prepInstructions: [
      ...
      "Empty your bladder approximately 1 hour before the exam, then drink 2 glasses of water and do not void — a mildly full bladder improves pelvic imaging.",
      "Remove all jewelry and metal objects.",
      "Inform the facility of all metal implants, IUD, or prior pelvic surgeries.",
      "Note: An IUD (including Mirena/copper) is generally MRI-safe — confirm with radiologist.",
      "If claustrophobic, notify your provider in advance.",
      "The exam takes approximately 45–60 minutes.",
    ],
    patientNote: "A pelvic MRI provides detailed images of the uterus, ovaries, and surrounding structures without radiation. It is the best study for evaluating fibroids, endometriosis, or complex ovarian findings.",
  },
];
