...
const ivFormulas = [
    ...
    },
    {
        ...
        sizes: [{
            size: "One Size",
            ingredients: ["4ml / 2,000mg Ascorbic Acid C", "3ml Vita Complex", "1ml / 10mg Biotin"]
        }]
    },
    {
        name: "Immunize",
...
const wellnessShots = [
    {
        ...
        icon: "💊",
        sizes: [
            { size: "Mid (1.5ml)", ingredients: ["0.5ml B12", "0.25ml / 2.5mg Biotin", "0.5ml Vita Complex"] },
            { size: "Max (3ml)", ingredients: ["1ml B12", "0.5ml / 5mg Biotin", "1ml Vita Complex"] },
        ]
    },
    {
